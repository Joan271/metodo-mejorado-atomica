...
\begin{align}
   ...
   L_\text{max} = 2l\times \text{floor}\left(\frac{N}{2}\right)-2\frac{\left(\text{floor}\left(\frac{N}{2}\right)-1\right)\left(\text{floor}\left(\frac{N}{2}\right)\right)}{2}+\left[l-\text{floor}\left(\frac{N}{2}\right)\right]\times \text{mod}(N,2)   
 \end{align}
